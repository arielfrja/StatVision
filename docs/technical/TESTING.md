...
2.  **Login:** Use the placeholder test credentials provided in your `.env` file to log in via the React app.
3.  **Observe Token:** Upon successful login, the authentication ID token will be displayed at the top.
